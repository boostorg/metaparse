#ifndef BOOST_METAPARSE_V2_IMPL_NTH_OF_C_HPP
#define BOOST_METAPARSE_V2_IMPL_NTH_OF_C_HPP
...
namespace boost
{
  namespace metaparse
  {
    namespace v1
    {
      namespace impl
      {
        #ifdef BOOST_NTH_OF_CASE
        #  error BOOST_NTH_OF_CASE already defined
        #endif
        #define BOOST_NTH_OF_CASE(z, n, unused) \
          template < \
