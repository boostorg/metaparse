#ifndef BOOST_METAPARSE_V1_FOLDLF_START_WITH_PARSER_HPP
#define BOOST_METAPARSE_V1_FOLDLF_START_WITH_PARSER_HPP
...
namespace boost
{
  namespace metaparse
  {
    namespace v1
    {
      ...
      class foldlf_start_with_parser
      {
      private:
        template <class Res>
        ...
        {};
      public:
        typedef foldlf_start_with_parser type;
