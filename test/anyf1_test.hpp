...
{ 
  ...
  typedef anyf1<letter_pair> anyf1_letter_pair;
  ...
  // test_empty_input
  BOOST_MPL_ASSERT(( is_error< apply_wrap2<anyf1_letter_pair, str_, start> > ));
  
  // test0
  BOOST_MPL_ASSERT((
    is_error<apply_wrap2<anyf1_letter_pair, chars0, start> >
  ));
  
  // test1_pair
  BOOST_MPL_ASSERT((
    equal<
      get_result<apply_wrap2<anyf1_letter_pair, chars2, start> >::type,
  ...
  BOOST_MPL_ASSERT((
    is_error<apply_wrap2<anyf1_letter_pair, chars3, start> >
  ));

   // test2_pairs
  BOOST_MPL_ASSERT((
    equal<
      get_result<apply_wrap2<anyf1_letter_pair, chars4, start> >::type,
  ...
  BOOST_MPL_ASSERT((
    equal<
      get_result<apply_wrap2<anyf1_letter_pair, chars6, start> >::type,
      vector<
        vector_c<char, 'h','e'>,
        vector_c<char, 'l','l'>,
        vector_c<char, 'o','w'>
  ...
  BOOST_MPL_ASSERT((
    equal<
      get_result<apply_wrap2<anyf1_letter_pair, chars8, start> >::type,
      vector<
        vector_c<char, 'h','e'>,
        vector_c<char, 'l','l'>,
        vector_c<char, 'o','w'>,
  ...
  BOOST_MPL_ASSERT((
    equal<
      get_result<apply_wrap2<anyf1_letter_pair, chars10, start> >::type,
      vector<
        vector_c<char, 'h','e'>,
        vector_c<char, 'l','l'>,
        vector_c<char, 'o','w'>,
  ...
  BOOST_MPL_ASSERT((
    equal<
      get_result<apply_wrap2<anyf1<always_int>, str_ca, start> >::type,
      vector<int, int>
    >
  ));
}
